...
procedure TForm3.Obyek2D (Sender: TObject; var Obyek:Matrik3N);
var
i,j :Integer;
begin
  for i := 1 to 2 do
...
procedure TForm3.MatrikRotasi2D(Sender: TObject; var R : Matrik33; sudut :Real);
var Radian:Real;
begin
sudut := StrToFloat(eNilaiA.Text);
...
procedure MatrikMirrorX  (var Mx : Matrik33);
begin
...
procedure MatrikMirrorY (var My : Matrik33);
begin
